export default {
  global: {
    ...
    descripcionCurso:
      'La programación de la producción es un tema administrativo de gran <br/> importancia en donde se incluyen procesos y labores de toda la unidad <br/> productiva, tales como las buenas prácticas, el reconocimiento de las <br/> enfermedades de control oficial, los sistemas productivos, entre otras.',
